...
> # 🧠 ПРОЧТИ ПЕРВЫМ / READ FIRST: [`DEEP_WORK_PROTOCOL.md`](DEEP_WORK_PROTOCOL.md)
> **Любой ИИ и любой человек обязан сначала прочитать этот файл.** Он описывает,
> КАК нужно работать над любой задачей в этом репозитории: глубокая автономная
> работа (deep work), а не режим чат-бота. Только после него читай стратегии и бэктесты.
