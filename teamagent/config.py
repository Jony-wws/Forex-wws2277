...
MIN_PROBABILITY = 0.80     # открываем только если ≥80% (user request 2026-05-05)
...
STRICT_QUALIFIED_GATE = True   # 2026-05-05: user wants ≥80% WR on every pair — only qualified cells
...
# ячейку QUALIFIED. 2026-05-05: unified с ENSEMBLE_MIN_AGREEMENT_PCT (line 83).
# Duplicate removed — single source of truth is line 83 above.
